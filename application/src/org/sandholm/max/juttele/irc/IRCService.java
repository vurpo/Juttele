...
import org.sandholm.max.juttele.activity.ServersActivity;
import org.sandholm.max.juttele.db.Database;
import org.sandholm.max.juttele.model.*;
import org.sandholm.max.juttele.receiver.ReconnectReceiver;
...
{
    public static final String ACTION_FOREGROUND = "org.sandholm.max.juttele.service.foreground";
    public static final String ACTION_BACKGROUND = "org.sandholm.max.juttele.service.background";
    public static final String ACTION_ACK_NEW_MENTIONS = "org.sandholm.max.juttele.service.ack_new_mentions";
    public static final String EXTRA_ACK_SERVERID = "org.sandholm.max.juttele.service.ack_serverid";
    public static final String EXTRA_ACK_CONVTITLE = "org.sandholm.max.juttele.service.ack_convtitle";
    ...
    private void handleCommand(Intent intent)
    {
        if (ACTION_FOREGROUND.equals(intent.getAction())) {
            ...
            notification = new Notification(R.drawable.icon_status, getText(R.string.notification_running), System.currentTimeMillis());
    ...
    {
        if (foreground) {
            notification = new Notification(R.drawable.icon_status, text, System.currentTimeMillis());
            Intent notifyIntent = new Intent(this, ServersActivity.class);
            notifyIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            PendingIntent contentIntent = PendingIntent.getActivity(this, 0, notifyIntent, 0);
