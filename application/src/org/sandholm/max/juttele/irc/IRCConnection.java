 ...
 */
package org.sandholm.max.juttele.irc;
...
import org.sandholm.max.juttele.Yaaic;
import org.sandholm.max.juttele.command.CommandParser;
import org.sandholm.max.juttele.model.*;
...
{
    private static final String TAG = "Juttele/IRCConnection";
    ...
    protected void onVersion(String sourceNick, String sourceLogin,    String sourceHostname, String target)
    {
        this.sendRawLine(
            ...
            "Juttele - The nice IRC client - http://max.sandholm.org/juttele" +
            "\u0001"
        );
    }
    ...
    public void onConnect()
    {
        ...
        Message message = new Message(service.getString(R.string.message_connected, server.getTitle()), Message.TYPE_MISC);
        message.setColor(Message.COLOR_GREEN);
        server.getConversation(ServerInfo.DEFAULT_NAME).addMessage(message);

        Message infoMessage = new Message(service.getString(R.string.message_now_login), Message.TYPE_MISC);
    ...
    public void onRegister()
    {
        ...
        Message infoMessage = new Message(service.getString(R.string.message_login_done), Message.TYPE_MISC);
        infoMessage.setColor(Message.COLOR_GREY);
        server.getConversation(ServerInfo.DEFAULT_NAME).addMessage(infoMessage);
    ...
    {
        Message message = new Message(service.getString(R.string.message_deop, sourceNick, recipient), Message.TYPE_MISC);
    ...
    {
        Message message = new Message(service.getString(R.string.message_devoice, sourceNick, recipient), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
    ...
    protected void onInvite(String targetNick, String sourceNick, String sourceLogin, String sourceHostname, String target)
    {
        if (targetNick.equals(this.getNick())) {
            // We are invited
            Message message = new Message(service.getString(R.string.message_invite_you, sourceNick, target), Message.TYPE_MISC);
            ...
            // Someone is invited
            Message message = new Message(service.getString(R.string.message_invite_someone, sourceNick, targetNick, target), Message.TYPE_MISC);
            server.getConversation(target).addMessage(message);
    ...
    protected void onKick(String target, String kickerNick, String kickerLogin, String kickerHostname, String recipientNick, String reason)
    {
        if (recipientNick.equals(getNick())) {
            ...
            Message message = new Message(service.getString(R.string.message_kick, kickerNick, recipientNick), Message.TYPE_MISC);
            message.setColor(Message.COLOR_GREEN);
            server.getConversation(target).addMessage(message);
    ...
    protected void onNickChange(String oldNick, String login, String hostname, String newNick)
    {
        if (getNick().equalsIgnoreCase(newNick)) {
            ...
            Message message = new Message(service.getString(R.string.message_self_rename, newNick), Message.TYPE_MISC);
            message.setColor(Message.COLOR_GREEN);
            server.getConversation(ServerInfo.DEFAULT_NAME).addMessage(message);
            ...
            Intent nickIntent = Broadcast.createServerIntent(
                    Broadcast.SERVER_NICK,
                    server.getId()
            );

            service.sendBroadcast(intent);
            service.sendBroadcast(nickIntent);
        }

        Vector<String> channels = getChannelsByNickname(newNick);

        for (String target : channels) {
            Message message = new Message(service.getString(R.string.message_rename, oldNick, newNick), Message.TYPE_MISC);
            message.setColor(Message.COLOR_GREEN);
            server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_op, sourceNick, recipient), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        message.setIcon(R.drawable.op);
        server.getConversation(target).addMessage(message);
    ...
    protected void onQuit(String sourceNick, String sourceLogin, String sourceHostname, String reason)
    {
        ...
        if (service.getSettings().showJoinPartAndQuit()) {
            ...
            if (conversation != null) {
                Message message = new Message(
                    service.getString(R.string.message_quit, sourceNick),
                    Message.TYPE_MISC
                );
    ...
    {
        if (changed) {
            Message message = new Message(service.getString(R.string.message_topic_set, setBy, topic), Message.TYPE_MISC);
            message.setColor(Message.COLOR_YELLOW);
            server.getConversation(target).addMessage(message);
        } else {
            Message message = new Message(service.getString(R.string.message_topic, topic), Message.TYPE_MISC);
            message.setColor(Message.COLOR_YELLOW);
            server.getConversation(target).addMessage(message);
        }
    ...
    {
        Message message = new Message(service.getString(R.string.message_voice, sourceNick, recipient), Message.TYPE_MISC);
        message.setIcon(R.drawable.voice);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_remove_channel_key, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_channel_key, sourceNick, key), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_channel_secret, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_channel_public, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_channel_limit, sourceNick, limit), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_remove_channel_limit, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_ban, sourceNick, hostmask), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_remove_ban, sourceNick, hostmask), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_topic_protection, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_remove_topic_protection, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_disable_external, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_enable_external, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_invite_only, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_remove_invite_only, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_moderated, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_remove_moderated, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    {
        Message message = new Message(service.getString(R.string.message_set_channel_private, sourceNick), Message.TYPE_MISC);
        message.setColor(Message.COLOR_BLUE);
        server.getConversation(target).addMessage(message);
    ...
    protected void onServerResponse(int code, String response)
    {
        ...
        if (code == 376 && ignoreMOTD) {
            Message motdMessage = new Message(service.getString(R.string.message_motd_suppressed), Message.TYPE_MISC);
        ...
        Message message = new Message(response, Message.TYPE_MISC);
        message.setColor(Message.COLOR_GREY);
        server.getConversation(ServerInfo.DEFAULT_NAME).addMessage(message);
    ...
    public void onDisconnect()
    {
        ...
        for (Conversation conversation : conversations) {
            Message message = new Message(service.getString(R.string.message_disconnected), Message.TYPE_MISC);
