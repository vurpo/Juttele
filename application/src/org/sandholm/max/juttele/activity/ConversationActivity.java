 ...
 */
package org.sandholm.max.juttele.activity;
...
import org.sandholm.max.juttele.adapter.ConversationPagerAdapter;
import org.sandholm.max.juttele.adapter.MessageListAdapter;
import org.sandholm.max.juttele.command.CommandParser;
import org.sandholm.max.juttele.indicator.ConversationIndicator;
import org.sandholm.max.juttele.indicator.ConversationTitlePageIndicator.IndicatorStyle;
import org.sandholm.max.juttele.irc.IRCBinder;
import org.sandholm.max.juttele.irc.IRCConnection;
import org.sandholm.max.juttele.irc.IRCService;
import org.sandholm.max.juttele.listener.ConversationListener;
import org.sandholm.max.juttele.listener.ServerListener;
import org.sandholm.max.juttele.model.*;
import org.sandholm.max.juttele.receiver.ConversationReceiver;
import org.sandholm.max.juttele.receiver.ServerReceiver;
...
public class ConversationActivity extends SherlockActivity implements ServiceConnection, ServerListener, ConversationListener
{
    ...
    public void onResume()
    {
        ...
        registerReceiver(serverReceiver, new IntentFilter(Broadcast.SERVER_NICK));
        ...
        ((Button) findViewById(R.id.completionButton)).setOnClickListener(new View.OnClickListener() {
        ...
        if (conversation != null) {
            if (!text.trim().startsWith("/")) {
                if (conversation.getType() != Conversation.TYPE_SERVER) {
                    ...
                    conversation.addMessage(new Message(text, Message.TYPE_OWN_MESSAGE));
    ...
    private void doNickCompletion() {
        ...
        doNickCompletion((EditText) findViewById(R.id.input));
    }
