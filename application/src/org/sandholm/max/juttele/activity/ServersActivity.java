...
import org.sandholm.max.juttele.adapter.ServerListAdapter;
...
import org.sandholm.max.juttele.model.Extra;
import org.sandholm.max.juttele.model.Server;
import org.sandholm.max.juttele.model.Status;
...
public class ServersActivity extends SherlockActivity implements ServiceConnection, ServerListener, OnItemClickListener, OnItemLongClickListener {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        View headerFooterView = new View(getApplicationContext());
        list.addHeaderView(headerFooterView);
        list.addFooterView(headerFooterView);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Server server = adapter.getItem(position-1);
