 ...
 */
package org.sandholm.max.juttele.command;

import java.util.HashMap;

import org.sandholm.max.juttele.command.handler.AMsgHandler;
import org.sandholm.max.juttele.command.handler.AwayHandler;
import org.sandholm.max.juttele.command.handler.BackHandler;
import org.sandholm.max.juttele.command.handler.CloseHandler;
import org.sandholm.max.juttele.command.handler.DCCHandler;
import org.sandholm.max.juttele.command.handler.DeopHandler;
import org.sandholm.max.juttele.command.handler.DevoiceHandler;
import org.sandholm.max.juttele.command.handler.EchoHandler;
import org.sandholm.max.juttele.command.handler.HelpHandler;
import org.sandholm.max.juttele.command.handler.JoinHandler;
import org.sandholm.max.juttele.command.handler.KickHandler;
import org.sandholm.max.juttele.command.handler.MeHandler;
import org.sandholm.max.juttele.command.handler.ModeHandler;
import org.sandholm.max.juttele.command.handler.MsgHandler;
import org.sandholm.max.juttele.command.handler.NamesHandler;
import org.sandholm.max.juttele.command.handler.NickHandler;
import org.sandholm.max.juttele.command.handler.NoticeHandler;
import org.sandholm.max.juttele.command.handler.OpHandler;
import org.sandholm.max.juttele.command.handler.PartHandler;
import org.sandholm.max.juttele.command.handler.QueryHandler;
import org.sandholm.max.juttele.command.handler.QuitHandler;
import org.sandholm.max.juttele.command.handler.RawHandler;
import org.sandholm.max.juttele.command.handler.TopicHandler;
import org.sandholm.max.juttele.command.handler.VoiceHandler;
import org.sandholm.max.juttele.command.handler.WhoisHandler;
